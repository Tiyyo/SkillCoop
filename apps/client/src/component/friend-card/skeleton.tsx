function FriendCardSkeleton() {
  return (
    <div className="relative">
      <div className="animate-opacity-in z-10 bg-base-light w-full h-full absolute"></div>
      <div className="relative z-0 flex animate-pulse py-2 px-3 gap-3 items-center">
