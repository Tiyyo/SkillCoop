/*
  ...
  - Added the required column `id` to the `mvp_poll` table without a default value. This is not possible if the table is not empty.
  - Added the required column `id` to the `best_striker_poll` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_best_striker_poll" ("created_at", "event_id", "profile_id", "updated_at") SELECT "created_at", "event_id", "profile_id", "updated_at" FROM "best_striker_poll";
