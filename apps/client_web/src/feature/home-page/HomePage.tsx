...
function HomePage() {
  return (
      ...
      <p className="absolute bottom-12 -left-6 -rotate-90 font-normal text-light lg:text-white">SKILL<span className="text-primary-1000 font-bold">COOP</span></p>
        ...
        <div className="flex flex-col items-end gap-1 max-w-[500px]">
          <p className="text-6xl text-primary-1000 font-paytone self-center lg:self-end">Create .</p>
          <p className="text-6xl text-primary-1000 font-paytone self-center lg:self-end">Play .</p>
