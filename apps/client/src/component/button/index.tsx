  ...
  return (
    ...
    >
      <path
        ...
        72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 
        50.5908Z"
        fill="#E5E7EB"
      />
      <path
        ...
        10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 
        21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 
  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === 'solid' && solid,
        variant === 'light' && light,
        variant === 'solid' && isLoading && 'bg-primary-400',
        variant === 'light' && isLoading && 'bg-primary-200',
        className,
      )}
      disabled={isLoading}
    >
