...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      `focus-visible:ring-ring focus-visible:ring-offset-background peer inline-flex h-4 w-8 shrink-0 
      cursor-pointer items-center rounded-full border-2 
      border-transparent shadow-sm transition-colors 
      focus-visible:outline-none focus-visible:ring-2 
      focus-visible:ring-offset-2 disabled:cursor-not-allowed 
      disabled:opacity-50 data-[state=checked]:bg-primary-500 
    ...
    <SwitchPrimitives.Thumb
      className={cn(
        `bg-background pointer-events-none block h-4 w-4 rounded-full 
         bg-primary-600 shadow-lg ring-0 
