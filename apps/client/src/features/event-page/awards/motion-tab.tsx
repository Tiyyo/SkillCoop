...
export const MotionTabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          `no-visible-scrollbar relative flex w-full max-w-full 
      ...
      >
        {propTabs.map((tab, idx) => (
          <button
            ...
            className={cn('relative rounded-full px-5 py-1.5', tabClassName)}
            style={{
          ...
          >
            {active.value === tab.value && (
              <motion.div
                ...
                className={cn(
                  'absolute inset-0 rounded-full bg-primary-800',
                  activeTabClassName,
                )}
              />
            )}
