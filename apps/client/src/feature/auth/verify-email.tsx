  ...
  return (
    <>
      <Page>
        ...
        <Center>
          <div
            className="max-w-[80%] relative flex flex-col font-bold
           text-primary-1000 justify-center gap-8 text-lg bg-box px-8 
            py-12 shadow-lg rounded-xl"
          >
            <img
              src={paperPlane}
          ...
          <p className="max-w-[80%] text-xs text-center py-4 text-primary-1100">
            {t('emptyMailbox')} ?{' '}
            <span
