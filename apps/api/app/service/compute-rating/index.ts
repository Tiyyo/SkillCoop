...
//   // TODO
//consider to first user Promise.all to make this async/await in parallel
...
//   const NB_EVAL_RECEIVED = avgEvalsReceivedQueryResult
//                .rows[0]
//                .nb_eval_received
...
// WEIGHT_OWN_EVAL) + avgEvalReceived.shooting + (VALUE_BONUS * NB_STRIKER))
...
async function computeRatingUser(profileId: number) {
  ...
  function avgIndividualSkill(
    userEval: number | undefined,
