...
INSERT INTO "new_profile_on_event" ("created_at", "event_id", "id", "profile_id", "status_name", "team", "updated_at") SELECT "created_at", "event_id", "id", "profile_id", "status_name", "team", "updated_at" FROM "profile_on_event";
